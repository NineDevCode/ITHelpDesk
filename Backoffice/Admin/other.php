...
<body>
    ...
    <script>
        <?php
        if (isset($_SESSION['accept_other'])) {
            if ($_SESSION['accept_other'] == 'success') { ?>
                swal({
                    title: 'รับงานสำเร็จ!',
                ...
                <?php
                $_SESSION['accept_other'] = '';
            }
            if ($_SESSION['accept_other'] == 'false') {
                ?>
                swal({
        ...
        ?>
        <?php
        if (isset($_SESSION['cancel_other'])) {
            if ($_SESSION['cancel_other'] == 'success') { ?>
                swal({
                ...
                <?php
                $_SESSION['cancel_other'] = '';
            }
            if ($_SESSION['cancel_other'] == 'false') {
                ?>
                swal({
        ...
        ?>
        <?php
        if (isset($_SESSION['finish_other'])) {
            if ($_SESSION['finish_other'] == 'success') {
                ?>
                swal({
                    title: 'ปิดงานสำเร็จ!',
                    icon: 'success',
                ...
                <?php
                $_SESSION['finish_other'] = '';
            } else if ($_SESSION['finish_other'] == 'false') {
                ?>
                    swal({
    ...
    <script>
        $('#data-table-default').DataTable({
            responsive: true,
            ajax: {
                url: '../../Routes/ajax.php?ajax_name=other',
                type: 'GET',
            },
            columns: [
                { data: "other_id" },
