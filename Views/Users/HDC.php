...
<body>
	...
	<div id="app" class="app app-header-fixed app-sidebar-fixed app-with-wide-sidebar app-with-light-sidebar">
		...
		<div id="content" class="app-content">
			...
			<!-- BEGIN panel -->
            <div class="card">
                <div class="card-header"><h6>ข้อมูลทั่วไป</h6></div>
                <div class="card-body">
                    <div class="container">
                        <div class="row my-3">
                            <div class="col-2">
                            ...
                            <div class="col-5">
                                <input type="text" name="firstname" id="firstname" class="form-control" placeholder="ชื่อ" required>
                            </div>
                            <div class="col-5">
                        ...
                        <div class="row my-3">
                            <div class="col-6">
                                <select name="hoscode" id="hoscode" class="form-select" required>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-6">
                                <input type="text" name="tel" id="tel" class="form-control" placeholder="เบอร์โทรศัพท์" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row my-3">
                                <div class="col-6">
                                    <input type="text" name="urlpage" id="urlpage" class="form-control" placeholder="URL ของหน้าเว็บที่ต้องการให้ปรับปรุง" required="required">
                                    <textarea  name="problemdetail" id="promblemdetail" class="form-control mt-2" placeholder="รายละเอียดของปัญหาที่พบ" rows="8"></textarea>
                                </div >
                                <div class="col-6"> 
                                    <label for="problemtype" class="my-2">ประเภทของปัญหาที่พบ (เลือกได้มากกว่าหนึ่งข้อ)</label>
                                    <div class="form-check my-2">
                                        <input class="form-check-input" type="checkbox" id="checkbox1" name="promlem1"/>
                                        <label class="form-check-label" for="checkbox1">เว็บไซต์โหลดช้า</label>
                                    </div>
                                    <div class="form-check my-2">
                                        <input class="form-check-input" type="checkbox" id="checkbox2" name="promlem2" />
                                        <label class="form-check-label" for="checkbox2">เว็บไซต์ไม่สามารถเข้าใช้งานได้</label>
                                    </div>
                                    <div class="form-check my-2">
                                        <input class="form-check-input" type="checkbox" id="checkbox3" name="promlem3" />
                                        <label class="form-check-label" for="checkbox3">ลิงก์ไม่ทำงาน</label>
                                    </div>
                                    <div class="form-check my-2">
                                        <input class="form-check-input" type="checkbox" id="checkbox4" name="promlem4" />
                                        <label class="form-check-label" for="checkbox4">ข้อความแสดงข้อผิดพลาด (Error Message)</label>
                                    </div>
                                    <div class="form-check my-2">
                                        <input class="form-check-input" type="checkbox" id="checkbox4" name="promlem5" />
                                        <label class="form-check-label" for="checkbox5">ปัญหาการเข้าสู่ระบบ/สมัครสมาชิก</label>
                                    </div>
                                    <div class="form-check my-2">
                                        <input class="form-check-input" type="checkbox" id="checkbox5" name="promlem5" onclick="handleOther(event)"/>
                                        <label class="form-check-label" for="checkbox5">อื่น ๆ</label>
                                    </div>
                            ...
                            <div class="row my-3">
                                <div class="col-6">
                                    <input type="file" name="image" id="image"  class="form-control" placeholder="แนบไฟล์ภาพหน้าจอ (ถ้ามี)">
                                </div>
                                <div class="col-6">
                                    <input type="text" name="datadetail" id="datadetail" class="form-control" placeholder="รายละเอียดเพิ่มเติ่ม">
                                </div>
                            </div>
                            <div class="row my-3">
