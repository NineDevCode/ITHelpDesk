...
<body>
    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed app-with-wide-sidebar app-with-light-sidebar">
        ...
        <div id="content" class="app-content">
            ...
            <?php
            $web = new Web();
            $web_info = $web->get_web_byid($_GET['web_id']);
            ?>
            <div class="card">
                        ...
                        <div class="row my-3">
                            <div class="col-2">
                                <select name="titlename" id="titlename" class="form-select" disabled>
                                    <option value="" <?php if ($web_info['titlename'] == '') {
                                        echo 'selected';
                                    } ?>>โปรดเลือกคำนำหน้าชื่อ
                                    </option>
                                    <option value="นาย" <?php if ($web_info['titlename'] == 'นาย') {
                                        echo 'selected';
                                    } ?>>นาย</option>
                                    <option value="นางสาว" <?php if ($web_info['titlename'] == 'นางสาว') {
                                        echo 'selected';
                                    } ?>>นางสาว
                                    </option>
                                    <option value="นาง" <?php if ($web_info['titlename'] == 'นาง') {
                                        echo 'selected';
                                    } ?>>นาง</option>
                                </select>
                            </div>
                            <div class="col-5">
                                <input type="text" name="firstname" id="firstname" class="form-control"
                                    placeholder="ชื่อ" value="<?= $web_info['firstname'] ?>" readonly>
                            </div>
                            <div class="col-5">
                                <input type="text" name="lastname" id="lastname" class="form-control"
                                    placeholder="นามสกุล" required value="<?= $web_info['lastname'] ?>" readonly>
                            </div>
                        </div>
                        <div class="row my-3">
                            <div class="col-6">
                                <select name="hoscode_id" id="hoscode_id" class="form-select hoscode_slelct" disabled>
                                    <option value="<?= $web_info['hoscode_id'] ?>"><?= $web_info['name'] ?></option>
                                </select>
                            </div>
                            <div class="col-6">
                                <select name="department_id" id="department_id" class="form-select" disabled>
                                    <option value="<?= $web_info['department_id'] ?>">
                                        <?= $web_info['department_name'] ?>
                                    </option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="container">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-check my-2">
                                    <input class="form-check-input" type="checkbox" id="checkbox1" name="promlem1"
                                        value="เว็บไซต์โหลดช้า" <?php if ($web_info['promlem1'] != NULL) {
                                            echo 'checked';
                                        } ?> disabled />
                                ...
                                <div class="form-check my-2">
                                    <input class="form-check-input" type="checkbox" id="checkbox2" name="promlem2"
                                        value="เว็บไซต์ไม่สามารถเข้าใช้งานได้" <?php if ($web_info['promlem2'] != NULL) {
                                            echo 'checked';
                                        } ?> disabled />
                                ...
                                <div class="form-check my-2">
                                    <input class="form-check-input" type="checkbox" id="promlem3" name="promlem3"
                                        value="ลิงก์ไม่ทำงาน" <?php if ($web_info['promlem3'] != NULL) {
                                            echo 'checked';
                                        } ?> disabled />
                                ...
                                <div class="form-check my-2">
                                    <input class="form-check-input" type="checkbox" id="checkbox4" name="promlem4"
                                        value="ข้อความแสดงข้อผิดพลาด (Error
                                            Message)" <?php if ($web_info['promlem4'] != NULL) {
                                                echo 'checked';
                                            } ?>
                                        disabled />
                                ...
                                <div class="form-check my-2">
                                    <input class="form-check-input" type="checkbox" id="promlem5" name="promlem5"
                                        value="ปัญหาการเข้าสู่ระบบ/สมัครสมาชิก" <?php if ($web_info['promlem5'] != NULL) {
                                            echo 'checked';
                                        } ?> disabled />
                                    <label class="form-check-label"
                                ...
                                <div class="form-check my-2 d-flex align-items-center">
                                    <input class="form-check-input me-2" type="checkbox" id="promlem6" name="promlem6"
                                        onclick="handleOther(event)" value="อื่น ๆ" <?php if ($web_info['promlem6'] != NULL) {
                                            echo 'checked';
                                        } ?> disabled />
                                    <label class="form-check-label" for="promlem6" class="me-2">อื่น ๆ
                                    </label>
                                    <div id="otherProblem" class="mt-2">
                                        <input type="text" name="otherProblem" class="form-control ms-2" value="<?php if ($web_info['promlem6'] != NULL) {
                                            echo $web_info['otherProblem'];
                                        } ?>" readonly>
                                    </div>
                                </div>
                        ...
                        <div class="row my-3">
                            <div class="col-6">
                                <?php if ($web_info['image'] != NULL) { ?>
                                    <div id="gallery" class="gallery w-100">
                                        <div class="image gallery-group-1">
                                            <div class="image-inner">
                                                <a href="../<?= $web_info['image'] ?>" data-lightbox="gallery-group-1"
                                                    class="w-100">
                                                    <div class="img w-100"
                                                        style="background-image: url('../<?= $web_info['image'] ?>')">
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="col-6">
                                <input type="text" name="detail" id="detail" class="form-control"
                                    placeholder="รายละเอียดเพิ่มเติ่ม" value="<?= $web_info['detail'] ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <?php if ($web_info['status'] == 'finished') { ?>
                <div class="card mt-3">
                    <div class="card-header">
                        รายระเอียดการจบงาน
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <textarea name="finish_detail" id="finish_detail" class="form-control" rows="5"
                                        readonly><?= $web_info['finish_detail'] ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
