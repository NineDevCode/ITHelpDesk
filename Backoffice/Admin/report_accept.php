                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-6">
                                <input type="text" name="tel" id="tel" class="form-control" placeholder="เบอร์โทรศัพท์"
                                    value="<?= $report_info['tel'] ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row my-3">
                            <div class="col-6">
                                <input type="text" name="reportdatedetail" id="reportdatedetail" class="form-control"
                                    placeholder="รายละเอียดช่วงเวลาที่คุณ (ถ้ามี)"
                                ...
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input" type="checkbox" id="Excel" name="Excel" value="true"
                                        <?php if ($report_info['Excel'] == true) {
                                            echo "checked";
                                        } ?> disabled />
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="email" name="emailback" id="emailback" class="form-control"
                                    placeholder="อีเมลที่ต้องการให้ส่งรายงาน" value="<?= $report_info['emailback'] ?>"
                                    readonly>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row my-3">
                    <div class="col-12 d-flex justify-content-end">
                        <a href="../../Routes/routes.php?route_name=accept_work_report&report_id=<?= $_GET['report_id'] ?>"
